...
{
    public partial class frmBC_TL : Form
    {
        ...
        void loadData()
        {
            ...
            command.CommandText = "SELECT HO_TEN_NV, TEN_CV, LUONG_CB FROM NHAN_VIEN, LUONG, PHONG_BAN WHERE NHAN_VIEN.MA_LUONG = LUONG.MA_LUONG AND NHAN_VIEN.MA_PB = PHONG_BAN.MA_PB AND TEN_PB = N'" + txtTenPB.Text+"'";
        ...
        void loadData1()
        {
            ...
            command1.CommandText = "SELECT TEN_PB, SUM(LUONG_CB) AS TONG_LUONG FROM NHAN_VIEN, LUONG, PHONG_BAN WHERE NHAN_VIEN.MA_LUONG = LUONG.MA_LUONG AND NHAN_VIEN.MA_PB = PHONG_BAN.MA_PB GROUP BY TEN_PB";
        ...
        private void frmBC_TL_Load(object sender, EventArgs e)
        {
        ...
        private void dgv_Tien_Luong_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
        ...
        private void dvgTong_Luong_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtTong_Tien.Text = dvgTong_Luong.Rows[i].Cells[1].Value.ToString();
        ...
        public void Export(DataTable dt, string sheetName, string title)
        {
            ...
            Microsoft.Office.Interop.Excel.Range lg2 = oSheet.get_Range("B1", "B1");
            lg2.Value2 = "Mẫu số 01a - LDTL";
            Microsoft.Office.Interop.Excel.Range logo1 = oSheet.get_Range("A1", "B1");
            ...
            Microsoft.Office.Interop.Excel.Range lg22 = oSheet.get_Range("B2", "B2");
            lg22.Value2 = "Thông tư số 198/2023/TLD";
            Microsoft.Office.Interop.Excel.Range logo11 = oSheet.get_Range("A2", "B2");
            ...
            Microsoft.Office.Interop.Excel.Range head = oSheet.get_Range("A3", "B3");
            ...
            Microsoft.Office.Interop.Excel.Range ngay = oSheet.get_Range("A4", "B4");
            ...
            //Đơn vị
            Microsoft.Office.Interop.Excel.Range donvi = oSheet.get_Range("B5", "B5");
            ...
            cl2.Value2 = "Tổng lương";
            cl2.ColumnWidth = 50;
            Microsoft.Office.Interop.Excel.Range rowHead = oSheet.get_Range("A6", "B6");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Export(dt, "Tong_TL", "DANH SÁCH TỔNG TIỀN LƯƠNG");
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            Export1(dt, "Tong_TL_NV", "DANH SÁCH TIỀN LƯƠNG NV " + txtTenPB.Text.ToUpper());
        }
    }
}
